import { canonicalJson, canonicalWorkingState } from "./canonical";
...
export function proposalCanonicalJson(baseRevision: number, baseHash: string, constraints: readonly Constraint[], optionId: string, moves: readonly SubmittedMove[]): string { return canonicalJson({ contractVersion: "1.0.0", baseRevision, baseHash, constraints, optionId, moves }); }
